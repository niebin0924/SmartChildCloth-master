...
@interface CirclePosterViewController () <UITableViewDelegate,UITableViewDataSource,HJCActionSheetDelegate,popSheetDelegate>
{
    NSInteger currPage;
}
...
@implementation CirclePosterViewController
