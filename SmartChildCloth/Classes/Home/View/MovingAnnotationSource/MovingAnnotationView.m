...
// 暂停
- (void)pauseTrackingAnimationForPoints:(NSMutableArray *)points
{
    CACoordLayer *layer = ((CACoordLayer *)self.layer);
...
// 继续
- (void)resumeTrackingAnimationForPoints:(NSMutableArray *)points
{
    CACoordLayer *layer = ((CACoordLayer *)self.layer);
